      ...
      <div className="container relative grid lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/80 backdrop-blur border border-primary/20 text-primary text-xs font-semibold shadow-card">
            <ShieldCheck className="w-4 h-4" /> Лицензированная клиника №1 в городе
          </span>
          <h1 className="mt-6 text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.05]">
            Здоровая улыбка — <span className="text-gradient">наша забота</span>
          </h1>
          <p className="mt-6 text-lg md:text-xl text-muted-foreground max-w-xl leading-relaxed">
            Современная стоматологическая клиника с премиум сервисом. Безболезненное лечение,
            опытные врачи и передовые технологии для вашей идеальной улыбки.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button asChild size="lg" className="rounded-full px-8 h-14 text-base gradient-primary text-primary-foreground shadow-soft hover:shadow-glow transition-all border-0">
              <a href="#contact">
                Записаться на приём <ArrowRight className="ml-1 w-4 h-4" />
              </a>
            </Button>
          ...
          <div className="mt-10 flex items-center gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground"><strong className="text-foreground">4.9/5</strong> · 1,200+ пациентов</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <img
            ...
            width={1280}
            height={960}
            className="relative w-full h-auto rounded-[2rem] shadow-elevated object-cover aspect-[4/3]"
          />
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <div>
              <div className="font-bold">15+ лет</div>
              <div className="text-xs text-muted-foreground">опыта работы</div>
            </div>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: -20 }}
          ...
          >
            ...
            <div className="text-xs text-muted-foreground">довольных пациентов</div>
          </motion.div>
        </motion.div>
      </div>
    </section>
